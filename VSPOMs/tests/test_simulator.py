...
class SimulatorTestCase(TestCase):
    ...
    def test_simulator_attributes(self):
        ...
        self.assertIsInstance(self.simulator.species_specific_dispersal_constant, float)
        self.assertIsInstance(self.simulator.area_exponent_connectivity_b, float)
        self.assertIsInstance(self.simulator.species_specific_constant_colonisation_y, float)
        self.assertIsInstance(self.simulator.species_specific_extinction_constant_u, float)
        self.assertIsInstance(self.simulator.patch_area_effect_extinction_x, float)
    ...
    def test_simulator_parameters(self):
        ...
        self.assertEqual(self.simulator.species_specific_dispersal_constant, 0.1)
        self.assertEqual(self.simulator.area_exponent_connectivity_b, 0.2)
        self.assertEqual(self.simulator.species_specific_constant_colonisation_y, 0.3)
        self.assertEqual(self.simulator.species_specific_extinction_constant_u, 0.4)
        self.assertEqual(self.simulator.patch_area_effect_extinction_x, 0.5)
